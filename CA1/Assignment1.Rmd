...
- The estimated odds ratio is 0.7015 indicating that the men are 30% less likely to support legal abortion compared to women. 
...
```{r echo=FALSE}
# is the output necessary here? the results are already included in the tables
