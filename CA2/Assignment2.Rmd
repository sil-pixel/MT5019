...
# print the AIC score
model_aic <- AIC(model_tumor)
print(paste("AIC of the fitted model:", model_aic))
...
kable(data.frame(predicted_risk = p, confidence_interval = p_ci), caption = "Predicted Risk and Confidence Interval at log(dose) = -1.39")
