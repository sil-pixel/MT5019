...
Compute Odds Ratios from Coefficients:
  ...
  - Exponentiation of the coefficient ($e^\beta$) converts the log-odds into odds ratios, while keeping all other variables constant.
...
- Interpret the Results:
  ...
  - The odds ratio for a explanatory variable $X_i$ with respect to the response variable is $e^{\beta_i}$ where $\beta_i$ is the coefficient of $X_i$ in the model.
