...
-Significant Predictors
 ...
 - Intercept:
    ...
    - Odds ratio = 6.37: The baseline of child survival when all predi ctors are zero.
    
    - Highly significant (p < 0.001).
    
  - Mother's age (X):
  
    - Estimate = -0.5893: Older mothers have decreased odds of child survival.
  ...
  - Gestational age (Z):
    ...
    - Odds Ratio = 25.74: For a longer gestational age, the odds of child survival increase by 2574%.
    
    - Highly significant (p < 0.001).
    
### Conclusion:

The logistic regression analysis provides valuable insight into the factors influencing child survival. The significan predictors in the model are Mother's age and Gestational age, which have a significant impact on child survival odds.
...
- Gestational age: Longer gestational age significantly increases the odds of child survival, with a 2574% increase in odds for each additional day of gestation.
