...
- Implementation:
  ...
  - Threshold of 0.3, 0.5 and 0.7 are used to classify the predicted probabilities into binary outcomes to view the variation in the range of sensitivity and specificity.
